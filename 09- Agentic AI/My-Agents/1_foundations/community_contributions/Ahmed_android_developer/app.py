...
class Me:
    ...
    def __init__(self):
        ...
        self.name = "Ahmed Moasd"
        reader = PdfReader("me/Ahmed Mosad's Resume.pdf")
        self.resume = ""
...
If the user is engaging in discussion, try to steer them towards getting in touch via email; ask for their email and record it using your record_user_details tool. "
    ...
    def chat(self, message, history):
        ...
        while not done:
            response = response = self.gemini.chat.completions.create(model=self.model_name, messages=messages)
