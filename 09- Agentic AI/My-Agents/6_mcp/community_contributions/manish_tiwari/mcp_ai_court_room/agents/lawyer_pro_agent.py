...
"""Lawyer arguing in favor of the position aligned with the plaintiff / claim."""
...
class LawyerProAgent:
    SYSTEM = """You are a senior advocate arguing IN FAVOR of the claimant side.
Use precedent framing, constitutional hooks where apt, and brief social-impact color.
...
Advance your side forcefully but professionally."""
...
Advance your side forcefully but professionally."""
    ...
    async def argue_stream(
        ...
        """Stream argument tokens; caller accumulates full text."""
