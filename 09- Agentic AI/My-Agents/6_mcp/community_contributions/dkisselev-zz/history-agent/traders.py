...
import os
import json
from mcp_retry import MCPServerStdioWithRetry
        ...
        async with AsyncExitStack() as stack:
            trader_mcp_servers = [
                await stack.enter_async_context(
                    MCPServerStdioWithRetry(params, client_session_timeout_seconds=120)
                )
                for params in trader_mcp_server_params
            ]
            async with AsyncExitStack() as stack:
                # Use retry wrapper for researcher servers
