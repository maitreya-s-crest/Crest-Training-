...
When you have found interesting Tickers, you must use the Quant_Agent tool to get quantative information. You must use the sentiment_mcp tool to get the sentiment of the ticker to have a more complete picture.
...
Before giving out your findings, you must use the Quant_Agent tool to get quantative information about the Ticker. You must use the sentiment_mcp tool to get the sentiment of the ticker to have a more complete picture.
