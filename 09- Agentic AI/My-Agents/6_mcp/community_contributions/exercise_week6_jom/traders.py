...
from agents import Agent, ModelSettings, Tool, Runner, OpenAIChatCompletionsModel, trace
...
from aux_tool import quant_agent_tool
...
def get_model(model_name: str):
    if "/" in model_name:
        ...
        return OpenAIChatCompletionsModel(model=model_name, openai_client=anthropic_client)
    else:
        return model_name
